...
namespace Ruffles.Tests.Channels
{
    ...
    public class ReliableSequencedChannelTests
    {
        ...
        public void TestSimpleMessage()
        {
            ...
            HeapPointers pointers = serverChannel.HandleIncomingMessagePoll(new ArraySegment<byte>(messageMemory.Buffer, (int)messageMemory.VirtualOffset + 2, (int)messageMemory.VirtualCount - 2));
