...
Please send a [GitHub Pull Request to Ruffles](https://github.com/midlevel/Ruffles/pull/new/master) with a clear list of what you've done (read more about [pull requests](http://help.github.com/pull-requests/)).
...
we use the git commit messages to **generate the Ruffles change log**. We follow angular's message format.
...
```
perf(memory-manager): Improved performance by removing allocation locks

BREAKING CHANGE: Removes allocation locks, thread locking is now manual
```
Samples:
